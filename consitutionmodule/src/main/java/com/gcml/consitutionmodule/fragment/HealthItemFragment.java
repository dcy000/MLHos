package com.gcml.consitutionmodule.fragment;
...
import com.gcml.consitutionmodule.R;
...
public class HealthItemFragment extends Fragment {
    ...
    private View view;
    private ConsitutionActivity activity;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        activity = (ConsitutionActivity) getActivity();
...
//                点击自动翻页
                if (lastXChecedId != checkedId) {
                    ((ConsitutionActivity) getActivity()).nextCurrentPage();
                }
